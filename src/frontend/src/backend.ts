...
import type { RestaurantInfo as _RestaurantInfo, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addMenuItem(arg0: string, arg1: string, arg2: number, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createReservation(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createReservation(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listAvailableMenuItems(): Promise<Array<MenuItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.listAvailableMenuItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleMenuItemAvailability(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateMenuItem(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateReservationStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateReservationStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRestaurantInfo(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRestaurantInfo(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_RestaurantInfo]): RestaurantInfo | null {
    return value.length === 0 ? null : value[0];
}
